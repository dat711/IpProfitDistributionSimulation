...
public class TestDataFactory {
    ...
    * */
    ...
    public static void printWhenContractNodeGen(ContractNode contractNode){
        System.out.printf("Contract node with id: %s generated by contract with id %s %n%n", contractNode.getId(),
                contractNode.getContract().getId());

    }

    public static void printResponsibilityDetails(Responsibility responsibility){
        System.out.println("Responsibility details is: " + responsibility);
        System.out.println("Responsibility source details is: " + responsibility.getSource());
        System.out.println("Responsibility target details is: " + responsibility.getTarget());
        System.out.println("==================================================================");
    }
...
//            System.out.println("-------------------------------------------------");
//            System.out.println("-------------------------------------------------");
//            System.out.println("All Responsibilities printed out ");

//            allResponsibilities.forEach(TestDataFactory::printResponsibilityDetails);
